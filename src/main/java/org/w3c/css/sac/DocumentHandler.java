...
public interface DocumentHandler {
     ...
     *
     * @param source The URI of the style sheet. @@TODO can be NULL ! (inline style sheet)
     ...
     *
     * @param source The URI of the style sheet.
     * @exception CSSException Any CSS exception, possibly wrapping another
     *                         exception.  
     */
     ...
     *                         exception.  
     */
    public void endPage(String media, String pseudo_page) throws CSSException;
